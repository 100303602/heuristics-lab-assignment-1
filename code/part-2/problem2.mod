...
<<<<<<< HEAD
s.t. Breaks {i in FLIGHTS, j in FLIGHTS, k in PILOTS: i <> j and i < j}: Time_Between_Flights[i,j]*((x[k,i]+x[k,j])-3) >= Break_Times[k];
=======
s.t. Breaks {i in FLIGHTS, j in FLIGHTS, k in PILOTS: i <> j and i < j}: Break_Times[k]*(x[k,i]+x[k,j]-1)<= Time_Between_Flights[i,j];
>>>>>>> 0740f9f1719a69b3f10207d09d0860639bee1708
